...
data_path = "/home/jianxiu/Documents/EC/vis/kr12/kr12_ala_ec.csv"
...
change = pd.read_csv("kr12_ala_ec_log2.csv")
...
plt.xlabel("KR-12 alanine variants", size=15)
plt.xticks(rotation=0)
plt.legend(["Experimental MIC log2 fold change (μM)", "Predicted MIC log2 fold change (μM)"],prop={'size':13})
plt.savefig("/home/jianxiu/Documents/EC/pics/svg/kr12/kr12_ala_ec_log2.svg")
plt.close()
