...
#
#
att = pd.read_csv("aurein_att_ec.csv")
...
plt.xticks(size=12)
plt.yticks(size=12)
plt.savefig("/home/jianxiu/Documents/EC/pics/svg/aurein/aurein_att_29_scatter.svg")
plt.close()
...
fig_29.savefig("/home/jianxiu/Documents/EC/pics/svg/aurein/aurein_heat_29.svg")
plt.close()
print("smart")