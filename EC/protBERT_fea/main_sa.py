...
def gene_bert_fea(csv_path, tokenizer, train_fea_path):
    column = ["ID", "SEQUENCE_space", "SA_pMIC"]
...
if  __name__ == "__main__":
    ...
    for i in range(max_num_split):
        train_csv = "/home/jianxiu/Documents/SA/data/" + str(i) + "/train-SA.csv"
        train_fasta = "/home/jianxiu/Documents/SA/data/" + str(i) + "/train-SA.fasta"
        test_csv = "/home/jianxiu/Documents/SA/data/" + str(i) + "/test-SA.csv"
        test_fasta = "/home/jianxiu/Documents/SA/data/" + str(i) + "/test-SA.fasta"

        train_df = pd.read_csv(train_csv)
        train_fea_path = "/home/jianxiu/Documents/SA/data/" + str(i) + "/train-SA_bert.npy"
        ...
        y_train = train_df["SA_pMIC"].values

        test_df = pd.read_csv(test_csv)
        y_test = test_df["SA_pMIC"].values
        test_fea_path = "/home/jianxiu/Documents/SA/data/" + str(i) + "/test-SA_bert.npy"
        ...
        print("smart")
    ml_path = "/home/jianxiu/Documents/EC/bert_fea/bert_ml_SA.csv"
