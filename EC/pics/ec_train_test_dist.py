...
train_path = "/home/jianxiu/Documents/EC/data/0/train-EC.csv"
test_path  = "/home/jianxiu/Documents/EC/data/0/test-EC.csv"
...
plt.hist(train_seqs_len, color="lightblue", edgecolor="black", bins=p1_bins)
...
train_blue_patch = patches.Patch(color='lightblue', label='E. coli train set')
plt.rcParams["legend.fontsize"] = 15
plt.legend(handles=[train_blue_patch])
plt.savefig("/home/jianxiu/Documents/EC/pics/svg/data_ana/EC_train_len_hist.svg")
plt.close()

train_pmic = train["EC_pMIC"]
plt.rcParams['font.family'] = 'sans Serif'
plt.rcParams['font.serif'] = ['Arial']
p2_bins = np.arange(-4, 3, 0.5)
plt.hist(train_pmic, color="lightblue", edgecolor="black", bins=p2_bins) # aquamarine
...
plt.rcParams["legend.fontsize"] = 15
plt.legend(handles=[train_blue_patch])
plt.savefig("/home/jianxiu/Documents/EC/pics/svg/data_ana/EC_train_pMIC_hist.svg")
plt.close()
...
plt.rcParams["legend.fontsize"] = 15
plt.legend(handles=[train_blue_patch])
plt.savefig("/home/jianxiu/Documents/EC/pics/svg/data_ana/EC_train_aa_hist.svg")
plt.close()
...
plt.xlim([0, 65])
plt.ylim([0, 200])
test_green_patch = patches.Patch(color=test_color, label='E. coli test set')
plt.rcParams["legend.fontsize"] = 15
plt.legend(handles=[test_green_patch])
plt.savefig("/home/jianxiu/Documents/EC/pics/svg/data_ana/EC_test_len_hist.svg")
plt.close()

test_pmic = test["EC_pMIC"]
plt.rcParams['font.family'] = 'sans Serif'
plt.rcParams['font.serif'] = ['Arial']
p2_bins = np.arange(-4, 3, 0.5)
...
plt.rcParams["legend.fontsize"] = 15
plt.legend(handles=[test_green_patch])
plt.savefig("/home/jianxiu/Documents/EC/pics/svg/data_ana/EC_test_pMIC_hist.svg")
plt.close()
...
plt.rcParams["legend.fontsize"] = 15
plt.legend(handles=[test_green_patch])
plt.savefig("/home/jianxiu/Documents/EC/pics/svg/data_ana/EC_test_aa_hist.svg")
plt.close()
